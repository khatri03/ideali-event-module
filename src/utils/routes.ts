...
export const API_ROUTES = {
  ...
  eventRegistrationHoldTokenExtend: (eventUniqueId: string) =>
    `/api/events/${eventUniqueId}/register/hold-token/extend`,
  ...
  eventCartSeatRelease: (cartUniqueId: string) => `/api/events/cart/${cartUniqueId}/seats/release`,
  ...
  seatsIoSeatingLayoutThumbnail: (chartUniqueId: string) =>
    `/api/organizer/seatsio/seating-layouts/${chartUniqueId}/thumbnail`,
