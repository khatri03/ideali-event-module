...
/**
 * The buyer on the order, corrected. The address is the one the confirmation and every ticket already
 * went to, so a change to it is called out rather than saved quietly - an organizer fixing a typo would
 * otherwise leave believing the buyer now has their tickets.
 */
export function EventInvoiceBuyerDialog({
  ...
  return (
    <Dialog.Root open onOpenChange={(details) => (details.open ? null : onClose())} size={{ base: "full", md: "md" }}>
      ...
      <Dialog.Positioner p={{ base: 0, md: 4 }}>
        ...
        >
          ...
          <Dialog.Body px={{ base: 5, md: 6 }} py={5} overflowY="auto">
            <Stack gap={4}>
