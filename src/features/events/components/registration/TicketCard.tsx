...
export function TicketCard({
  ...
  const remainingLabel = getTicketRemainingLabel(ticket)
  ...
  return (
    <Stack gap={1.5} h="full">
      {/* Kept in the flow even with nothing to say, so a card that hides its count still lines its
          top edge up with the neighbour that shows one. */}
      <Text fontSize="xs" fontWeight="600" color="gray.500" px={1} minH="1.125rem" aria-hidden={!remainingLabel}>
        {remainingLabel ? remainingLabel.text : " "}
      </Text>
