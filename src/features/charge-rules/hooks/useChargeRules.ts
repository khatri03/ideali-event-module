...
import { createOrganizerChargeRule, fetchOrganizerChargeRules, updateOrganizerChargeRule, type OrganizerChargeRuleInput } from "@/api/chargeRules"
...
export function useChargeRules() {
  return useQuery({
    queryKey: CHARGE_RULE_QUERY_KEY,
    queryFn: fetchOrganizerChargeRules,
  })
}
