  ...
  return (
    <Stack gap={5} w="full">
      ...
      >
        ...
        <Stack gap={5}>
          <Box borderRadius="18px" border="1px solid" borderColor="border.subtle" bg="gray.50" p={{ base: 4, md: 5 }}>
            <Stack gap={3}>
              <Flex
              ...
              <Flex gap={2} flexWrap="wrap">
                {recipients.map((recipient) => (
                  <Tag.Root
                    ...
                    gap={1.5}
                  >
                    <Tag.Label lineClamp={1} title={recipient.email ? `${recipient.name} (${recipient.email})` : recipient.name} fontWeight="600">
                      {recipient.name}
                    </Tag.Label>
                    <Tag.EndElement ms={0}>
                      <Tag.CloseTrigger
